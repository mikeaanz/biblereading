...
ROUND(AVG(TEAMHOURS)) as TEAMHOURS,
week.`week` AS WeekType
...
// downward footer header
        ...
        $pdf->Row(Array('TOTAL/AVG',$row['HOMESKNOCK'],$row['HOMESPREACH'],$row['PCONTACTED'],$row['RECEIVEDGOSPEL'],$row['GOPENFOLLOW'],$row['btz'],$row['NEWHOMESMTG'],
          $row['TOTALHOMESMTG'],$row['TOTALPERSONHMTG'],$row['PVISITEDNOTHMEET'],$row['NSMALLGMTG'],$row['SMALLGMTGHELD'],$row['LOCALATTSMLMTG'],$row['LOCALSAINTSJOINPROP'],$row['MANHOURS'],$row['LTM'],$row['TEAMHOURS']));    
