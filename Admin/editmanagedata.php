...
<ul class="breadcrumb">
						...
						$termquery = mysql_query("SELECT * FROM `weekspropagation`
						...
						$term = $propagation['BATCH'];
                        $month = $propagation['MONTH'];
                        $year = $propagation['YR'];
                        $level =$propagation['LEVEL'];
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Manage Record Edit Data</h6>
	  </a>
...
<div class="col-xl-9 col-lg-6">
  ...
  Check All <input type="checkbox" class="switch"   name="selectAll" id="checkAll" />
	<a  href="#delete" class="btn btn-danger  btn-smll"  data-toggle="modal" data-target="#delete"><i class="fa fa-ban"> Disabled</i> </a>
  <div class="float-right">
    ...
    <div class="table-responsive">
          ...
          <td width="40px">		<input id="optionsCheckbox"  class="switch" name="selector[]" type="checkbox" value="<?php echo $id; ?>"></td>
				  ...
				  <td width="40">
                        <a   href="editmanagedata.php?locate_idpost=<?php echo $id; ?>"   class="btn btn-success"><i class="fa fa-edit text-white"></i></a>
												</td>
...
<?php include 'editfeedmanage.php' ?>
