...
<div class="col-xl-9 col-lg-6">
  <div class="card shadow mb-1">
    <h6 class="m-3 font-weight-bold text-danger">All Informations Active Trainee Profile</h6>
    ...
    <th>Relationship Contact Number :</th>
            ...
            <!--         <td width="40px">		<input id="optionsCheckbox" class="switch" name="selector[]" type="checkbox" value="<?php echo $id; ?>" data-toggle="tooltip" title="Check List"></td> -->
                    <td width="40">
                        ...
                        <td style="font-style:italic; color: #c92d22  ;"><?php echo $row['First_Name'];?> <?php echo $row['Middle_Name'];?> <?php echo $row['Last_Name'];?></td>
