...
?>
   ...
   include('includes/submitreportxd.php');
        ?>
        ...
        <ul class="breadcrumb">
						...
						?>
							<li><a href="#"><b>Propagations Area Fellowship</b></a><span class="divider">/</span></li>
							<li><a href="#"><?php echo $propagation['BATCH']; ?> 
                            term 
                             <?php echo $propagation['LEVEL']; ?>  <?php echo $area;?> </a></li>
						</ul>
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">By Area Report</h6>
	  </a>
				...
				<?php
							...
							$user_query = mysql_query("SELECT * FROM `weekspropagation`
							 inner join accounts on weekspropagation.accounts_id=accounts.id
							  inner join locality as asx on asx.id=accounts.LOCALITY 
							  INNER JOIN region on region.region_id=asx.region_id 
							  inner join area as dd on dd.Area_id=asx.area_id 
                            ...
                            where batch.BATCH='$term' and userlevel.LEVEL='$level' and dd.locations='$area'
				  ...
				  <td  class="m-3 font-weight-bold text-primary"><?php echo $row['MONTH'];?>, <?php echo $row['YR'];?>, <?php echo $row['week'];?>, <?php echo $row['BATCH'];?></td>
