    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form method="POST" action="reportteamsearch.php"  class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
 ...
 <select name="level" class="browser-default custom-select" required> 
   ...
   <?php 
   $result = mysql_query("SELECT * FROM userlevel where  LEVEL='LONG PROPAGATION' or LEVEL='5 DAYS PROPAGATION' or LEVEL='WEEKEND'
    ...
    <?php } ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <form method="POST" action="reportteamsearch.php" class="form-inline mr-auto w-100 navbar-search">
