    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form method="POST" action="weekdash.php"  class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
         ...
         while($rows = mysql_fetch_array($result))
         {
          ...
          <?php } ?>
                                                                ...
                                                                &nbsp;
 <select name="locality"    class="selectpicker" data-live-search="true"  data-size="6" data-width="60%" required> 
   
   <option value="">Select Accounts Type</option>
   <?php 
   $result = mysql_query("SELECT * from accounts AS accnt INNER JOIN locality AS lc ON lc.ID = accnt.locality WHERE USER_LEVEL ='2'
   ")or die(mysql_error());
   ...
   {
    ?>
    <option value='<?php echo $rows['id']; ?>'> Accounts : <?php echo $rows['USERNAME']; ?> <?php echo $rows['PLACES']; ?></option>
    <?php } ?>
                          </select>      
                          &nbsp;
<!-- 
 ...
 <select name="year" class="browser-default custom-select" required> 
   ...
   while($rows = mysql_fetch_array($result))
   {
    ...
    <?php } ?>
                          ...
                          <!-- &nbsp;
 <select name="level" class="browser-default custom-select" required> 
   
   <option value="">Select Level</option>
   <?php 
   $result = mysql_query("SELECT * FROM userlevel where  LEVEL='WEEKEND' or LEVEL='5 DAYS PROPAGATION'
    ...
    <?php } ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <form method="POST" action="weekdash.php" class="form-inline mr-auto w-100 navbar-search">
...
<?php } ?>
 ...
 <select name="level" class="browser-default custom-select" required> 
   ...
   <option value="">Select Level</option>
   <?php 
   $result = mysql_query("SELECT * FROM userlevel where  LEVEL='LONG PROPAGATION'
    order by id asc")or die(mysql_error());
