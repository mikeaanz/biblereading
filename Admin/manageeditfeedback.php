   ...
   <?php
    ...
    <div class="card-body">
			...
			<label class="control-label" >Status Posted :</label>
                  ...
                  <?php
                                  $query = mysql_query("select * from status where ID='2'")or die(mysql_error());
                                  while($row = mysql_fetch_array($query)){
                                  ?>
      ...
      <a  href="#success"  class="btn btn-primary  btn-smll" data-toggle="modal"    data-target="#manage" ><i class="fa fa-edit"></i>Edit Manage</a>
      </div>
...
$status_id=$_POST['status_id'];
    ...
    $act = "SELECT * FROM feedback WHERE MONTH='$month' and YEAR='$yr' and BATCH='$batch' and WEEK='$week' and status_id='$status_id' ";
...
echo '<script> swal({title: "Notice!",text: "When Editing the Data make sure that information has not been existed in the current database.", customClass: "swal-wide",
