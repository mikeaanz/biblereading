  ...
  <div class="card shadow mb-4">
   ...
   <!--Here yours Manipulation Data for Tables inner join call three table at the same time  ---->
    ...
    <form  method="POST">
        ...
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><i ></i>Batch</div>
...
<input class="form-control form-control-sm" name="week" id="cost" type="text" onfocus="this.value=''"  onkeypress="return isNumberKey(event)"  placeholder="Please Enter Week" required/>
...
if($activated > 0){
    ...
    mysql_query("INSERT INTO `week`(`week`) 
    VALUES ('$week')")or die(mysql_error());
