  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                  ...
                                                  inner join userlevel on userlevel.id=current_teamdata.userlevel_id
                                                   where batch.BATCH='$term' and month.MONTH='$month' and year.YR='$year'
                                                    ORDER BY current_teamdata.c_team_id DESC
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                   ...
                   <!-- Title -->
                        ...
                        <p class="card-text text-center bg-gradient-primary   " style="font-style:italic;"><a style='color:#F8FAFB' > Propagation </a><span style='color:#F8FAFB' ><?php echo $row['MONTH'];?> <?php echo $row['YR'];?> <?php echo $row['BATCH'];?></span></p>
                   ...
                   ,<?php echo $row['YR'];?>
                    ...
                    <div class="col text-center">	
                        <a href="addteamup.php?id=<?php echo $id; ?>" class="btn btn-primary "><i class="fa fa-plane"></i> Go to Locality</a>
                        <hr>
                    </div>
