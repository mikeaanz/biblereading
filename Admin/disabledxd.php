...
<ul class="breadcrumb">
   ...
   <form action="disabled.php?locate_idpost=<?php echo $trm; ?>" method="post">
<!-- Page Heading -->
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Manage Record Deactivated Data</h6>
	  </a>
