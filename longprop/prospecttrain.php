    ...
    <div class="table-responsive">
			  ...
			  <th>Contact # :</th>
				...
				<?php	
				  ...
				  <td width="40">
				  <a  href="prospectedit.php?historyfeedbackid=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
