...
<!-- <div class="container"> -->
  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                 ...
                                                 WHERE current_teamdata.userlevel_id='3'
                                                --    where batch.BATCH='$term' and month.MONTH='$month' and year.YR='$year'
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                              <h1 class="m-3 font-weight-bold text-primary text-right week">    <?php echo $row['LEVEL'];?></h1>
                    <!-- Card content -->
                    <div class="card" >
                   ...
                   <!-- Title -->
                        ...
                        <h5 class="card-text text-center bg-gradient-primary   " style="font-style:italic;"><a class="m-3 font-weight-bold" style='color:#BFEEF9' >Rev. 22:12 Behold, I come quickly, and My reward is with Me to render to each one as his work is.</a><span style='color:#F8FAFB' ></span></h5>
