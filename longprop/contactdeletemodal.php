  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <i class="fas fa-trash fa-4x mb-4 text-danger" aria-hidden="true"></i>
        <p>Are you sure? Do you want to DELETE this data! This Data also will Delete the Current Propagation Monitored Contacts Services, Please be aware of it, Thank you..</p>
        </div>
      </div>
...
for($i=0; $i < $N; $i++)
{
  ...
  $monitored = mysql_query("DELETE FROM weekendrpt where weekendrpt_id='$id[$i]'");
}
