...
<div class="col-xl-3">
  <div class="card shadow mb-4">
      <h6 class="m-3 font-weight-bold text-primary">District Recovered Information</h6>
    <!-- Card Body -->
    <form  method="POST">
    <div class="card-body">
			...
			<input class="form-control form-control-lg" name="date" id="price" type="date"  data-toggle="datepicker" readonly placeholder="Example +6393045311711" maxlength="11" disabled/>
