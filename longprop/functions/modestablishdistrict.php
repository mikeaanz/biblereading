  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-gradient-primary">
        <h5 class="modal-title" style='color:#F8FAFB'   id="samplemodal">    <i class="fa fa-plus"></i>Establish District Information</h5>
     ...
     -->
			...
			<label class="control-label" >Name of Establish Disctrict :</label>
      ...
      <div class="dates">
			...
			<input class="form-control form-control-lg" onkeypress="return isNumberKey(event)" 
data-toggle="datepicker" readonly style="background-color:#aed6f1;"  id="usr1" name="date"  placeholder="mm-dd-yyyy" autocomplete="off" required/>
...
$timesup=$_POST['date'];
  ...
  $act = "SELECT * FROM establish_dist WHERE `establishname`='$name' and acc_id='$session_id' and historyfeedback='$historyfeedbackid'";
...
echo '<script> swal({title: "Notice!",text: "Your data already existing.", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("editestablishdist.php?historyfeedbackid='.$historyfeedbackid.'&BATCH='.$getbatch.'","_self")});</script>';
exit();
...
// to be continue!!!
	...
	mysql_query("INSERT INTO `establish_dist`(`establishname`, `dateestablish`, `acc_id`, `historyfeedback`)
...
echo '<script> swal({title: "Good Job!",text: "Your Data Successfully Save!", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("editestablishdist.php?historyfeedbackid='.$historyfeedbackid.'&BATCH='.$getbatch.'","_self")});</script>';
exit();
