  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
     ...
     -->
			...
			<label class="control-label" >Name of Recovered Disctrict :</label>
...
$timesup=$_POST['date'];
  ...
  $act = "SELECT * FROM rec_district WHERE `districtname`='$name' and acc_id='$session_id' and historyfeedback='$historyfeedbackid'";
