...
echo '<script> swal({title: "Amen!",text: "Successfully Updated!", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("viewbaptism.php?locate_idpost='.$get_id.'&BATCH='.$getbatch.'&id='.$id.'","_self")});</script>';
exit();
}
...
exit();
  ...
  echo '<script> swal({title: "Praise the Lord!",text: "Data already submitted!", customClass: "swal-wide",
    confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("viewbaptism.php?locate_idpost='.$get_id.'&BATCH='.$getbatch.'&id='.$id.'","_self")});</script>';
  exit();
}
