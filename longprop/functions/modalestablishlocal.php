  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-gradient-primary">
        <h5 class="modal-title" style='color:#F8FAFB'   id="samplemodal">    <i class="fa fa-plus"></i>Establish Locality Information</h5>
     ...
     -->
			...
			<label class="control-label" >Name of Establish Locality :</label>
      ...
      <div class="dates">
			...
			<input class="form-control form-control-lg" onkeypress="return isNumberKey(event)" style="background-color:#aed6f1;" 

data-toggle="datepicker" readonly  id="usr1" name="date"  placeholder="mm-dd-yyyy" autocomplete="off" required/>
...
$timesup=$_POST['date'];
  ...
  $act = "SELECT * FROM establish_local WHERE `local_name`='$name' and acc_id='$session_id' and historyfeedback='$historyfeedbackid'";
...
echo '<script> swal({title: "Notice!",text: "Your data already existing.", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("establishlocality.php?locate_idpost='.$historyfeedbackid.'&BATCH='.$getbatch.'","_self")});</script>';
exit();
...
// to be continue!!!
	...
	mysql_query("INSERT INTO `establish_local`(`local_name`,`date_establish`, `acc_id`, `historyfeedback`)
     VALUES ('$name','$timesup','$session_id','$historyfeedbackid')")or die(mysql_error());
	
echo '<script> swal({title: "Amen!",text: "Your Data Successfully Save!", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("establishlocality.php?locate_idpost='.$historyfeedbackid.'&BATCH='.$getbatch.'","_self")});</script>';
exit();
