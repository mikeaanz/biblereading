  ...
  <?php
                                               ...
                                               LEFT JOIN year on historyfeedback.YEAR=year.ID
                                                  ...
                                                  LEFT JOIN week on historyfeedback.WEEK=week.ID
                                                   ...
                                                   where historyfeedback.acc_id='3'
...
<button   onclick="window.location.href='myentry.php?locate_idpost=<?php echo $id; ?>&BATCH=<?php echo $batch;?>'"    class="btn btn-primary" data-toggle="tooltip" title="Service Contact" <?php echo $row['list'];?>><i class="fa fa-plus-circle"></i></button>
