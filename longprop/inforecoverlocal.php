...
<div class="col-xl-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
			...
			<input class="form-control form-control-lg" name="date" id="price" data-toggle="datepicker" readonly type="date"  placeholder="Example +6393045311711" maxlength="11" disabled/>
