  ...
  <div class="card-body">
    ...
    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">	
                  ...
                  <?php
                           ...
                           RIGHT join current_teamdata on current_teamdata.c_team_id=baptism_rpt.curteam_id 
                    ...
                    <td width="40"> 
												<a  href="uptbaptize.php?id=<?php echo $get_id;?>&contacid=<?php echo  $contacid;?>&genderid=<?php echo $row['gender'];?>"   class="btn btn-success"><i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i></a>
												</td>
                        <!-- <td width="40">
                        ...
                        <td width="40px" class="text-info"><?php echo $row['Gender'];?></td>
