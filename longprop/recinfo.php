...
<div class="col-xl-3">
  <div class="card shadow mb-4">
    ...
    <label class="control-label" >Name of Brother and Sister:</label>
			<input class="form-control form-control" name="name" id="price" value="<?php echo  $row['Name'];?>"  type="text"  disabled/>

            <label class="control-label" for="price">Home Address:</label>
			<input class="form-control form-control" name="homeadd" id="price" value="<?php echo $row['Home_address'];?>" type="text"  disabled/>


            <label class="control-label" >Date Recovered:</label>
            <input type="date" class="form-control form-control" data-date-format="mm/dd/yyyy" data-toggle="datepicker" readonly

 value="<?php echo $row['Date_recovered'];?>"   name="daterec" disabled>
  
            <label class="control-label" for="price">Cell-Phone #:</label>
			<input class="form-control form-control" name="cell" id="price" type="Number" placeholder="Example +6393045311711" value="<?php echo $row['cellphone']; ?>" disabled/>
			...
			<label class="control-label" >Status :</label>
                  <Select class="browser-default custom-select" name="userlevel" id="userlevel" disabled>
      ...
      <a  href="#success"  class="btn btn-primary  btn-smll"  disabled><i class="fa fa-recycle"></i> Update</a>
      </div>
      </div>
      </div>
      </div>
