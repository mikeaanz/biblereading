...
<div class="card">
	...
	<div class="card shadow mb-4">
	  <div class="card-header py-3">
		  <h1 class="text-success text-right week"><?php echo $row['week'];?></h1>
...
<a  class="btn btn-info btn-small" href="recestlocal.php?locate_idpost=<?php echo $historyfeedbackid;?>"><i class="fa fa-user-plus ">Recovered Saints</i></a>
		...
		<h6 class="m-0 font-weight-bold text-success text-center">Propagation Data</h6>
	  </div>
	  <div class="card-body">
...
<!-- 		<label class="control-label" for="cost" >No. of Baptisms (Brothers):</label> -->
		 ...
		 <!--    <label class="control-label" for="price">No. of Baptisms (Sisters):</label> -->
			...
			<input class="form-control form-control-lg numbers" name="trainteamhrs" id="txtTeamHours" type="text"   		 maxlength="5"  required/>
...
$bapbro=$_POST['bapbro'];  $homesknock = $_POST['homesknock'];
$bapsis=$_POST['bapsis'];  $homespreach= $_POST['homespreach'];
$recbro=$_POST['recbro'];	$Pcontact= $_POST['Pcontact'];
