      ...
      <label class="control-label" >Day Three :</label>
                  <Select class="browser-default custom-select" name="three" id="userlevel" >
                     ...
                     <option  value="">Select Propagation Activities</option>
                       ...
                       <div class="form-group">
      <label class="control-label" >Day Four :</label>
                  <Select class="browser-default custom-select" name="four" id="userlevel" >
                ...
                <div class="form-group">
      <label class="control-label" >Day Five :</label>
                  <Select class="browser-default custom-select" name="five" id="userlevel" >
