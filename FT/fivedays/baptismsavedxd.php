        ...
        <ul class="breadcrumb">
						...
						?>
							<li><a href="#"><b>My Baptized Ones During :</b></a><span class="divider">/</span></li>
...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-1">
    ...
    <div class="card-body">
    <h3 class="m-3 font-weight-bold text-success">My Baptized Contacts</h3>
    ...
    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">	
                  ...
                  <?php
                          ...
                          RIGHT join locality on locality.ID=accounts.LOCALITY
                           where baptism_rpt.acc_id='$session_id' and batch.BATCH='$term' 
