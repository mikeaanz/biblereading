...
<!-- <div class="container"> -->
  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                 ...
                                                 WHERE current_teamdata.userlevel_id='4' and
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                              <h1 class="m-3 font-weight-bold text-success text-right week">    <?php echo $row['LEVEL'];?></h1>
                    <!-- Card content -->
                    <div class="card" >
                   ...
                   <!-- Title -->
                        ...
                        <!-- Text -->
                        <h5 class="m-3 font-weight-bold text-dark  text-center week" style="font-style:italic;"><?php echo $row['MONTH'];?> <?php echo $row['YR'];?> <?php echo $row['BATCH'];?> </h5>
