...
<div class="col-lg-12">
  ...
  Check All <input type="checkbox" class="switch"   name="selectAll" id="checkAll" />
	<a  href="#delete" class="btn btn-info  btn-smll"  data-toggle="modal" data-target="#delete"><i class="fa fa-toggle-on"> Enabled</i> </a>
  <div class="float-right">
    <ul class="nav nav-pills">

          <li class="active">
			<a  href="requestingnotif.php" class="btn btn-danger  btn-circle" ><i class="fa fa-ban"></i><i class="fa fa-activate"></i> </a>
				</li>
