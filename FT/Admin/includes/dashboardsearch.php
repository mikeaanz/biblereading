    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form method="POST" action="dashboard.php"  class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
 ...
 <select name="locality"    class="selectpicker" data-live-search="true"  data-size="6" data-width="60%" required> 
   ...
   <?php 
   $result = mysql_query("SELECT * from accounts AS accnt INNER JOIN locality AS lc ON lc.ID = accnt.locality WHERE USER_LEVEL ='3'
   ")or die(mysql_error());
...
<!-- 
 ...
 <select name="year" class="browser-default custom-select" required> 
  ...
  <input type="hidden" name="level" value="LONG PROPAGATION">
 -->
                          <!-- &nbsp;
    ...
    <?php } ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <form method="POST" action="dashboard.php" class="form-inline mr-auto w-100 navbar-search">
