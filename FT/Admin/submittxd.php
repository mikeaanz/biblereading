...
?>
   ...
   include('includes/submitreportxd.php');
        ...
        <ul class="breadcrumb">
						...
						?>
							<li><a href="#"><b>Propagations Regions Reports</b></a><span class="divider">/</span></li>
							<li><a href="#"><?php echo $propagation['BATCH']; ?> 
                            term
                             <?php echo $propagation['LEVEL']; ?> Regions  <?php echo $region;?> </a></li>
						</ul>
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Submitted Report</h6>
	  </a>
	...
	<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">	
			  ...
			  <th>Places</th> 
				...
				<?php
							...
							INNER JOIN region on region.region_id=locality.region_id
                            ...
                            where batch.BATCH='$term'  and userlevel.LEVEL='$level' and region.Region='$region'
