...
<div class="col-xl-9 col-lg-6">
  <div class="card shadow mb-1">
    <h6 class="m-3 font-weight-bold text-primary">Months Information</h6>
  ...
  <div class="card-body">
    <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
													$user_query = mysql_query("SELECT * from month ORDER BY ID ASC ")or die(mysql_error());
                    ...
                    <td width="40">
                    <a  href="editmonth.php?id=<?php echo $id; ?>"   class="btn btn-success"><i class="fa fa-edit"  data-toggle="tooltip" title="Edit"></i></a>
												</td>
...
<?php include 'functions/delete_month.php' ?>
