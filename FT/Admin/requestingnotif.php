	...
	include('includes/actmanagesearch.php');
	...
	<div class="card shadow mb-4">
		...
		<a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
			<h6 class="m-0 font-weight-bold text-primary text-center">Manage Record Feedback Data</h6>
		</a>
	...
	Check All <input type="checkbox" class="switch"   name="selectAll" id="checkAll" data-toggle="tooltip" title="All Check!" />
		<a  href="#delete" class="btn btn-danger  btn-smll"  data-toggle="modal" data-target="#delete"><i class="fa fa-ban" data-toggle="tooltip" title="Deactivated!"></i> </a>
	<div class="float-right">
		<ul class="nav nav-pills">

			<li class="active">
				<a  href="enabledbut.php" class="btn btn-info  btn-circle" ><i class="fa fa-toggle-on" data-toggle="tooltip" title="Proceed to Activated!"></i><i class="fa fa-activate"  ></i> </a>
					</li>
		...
		<div class="table-responsive">
			...
			<th></th>
					...
					<?php
																...
																where weekspropagation.manipulate_but=' '
			...
			<td width="40px">		<input id="optionsCheckbox"  class="switch" name="selector[]" type="checkbox" data-toggle="tooltip" title="Check List!" value="<?php echo $id; ?>"></td>
	...
	<?php include 'functions/blockbut.php' ?>
