...
<div class="col-xl-9 col-lg-5">
  <div class="card shadow mb-1">
    <h6 class="m-3 font-weight-bold text-warning">Locality Information</h6>
    ...
    <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    <td width="40">
                    <a  href="localityedit.php?id=<?php echo $id; ?>&region=<?php echo $region;?>&area=<?php echo $area;?>"  class="btn btn-success"><i class="fa fa-edit" data-toggle="tooltip" title="Edit" ></i></a>
												</td>
...
<?php include 'functions/delete_locality.php' ?>
