...
<div class="col-xl-9 col-lg-6">
  <div class="card shadow mb-1">
    <h6 class="m-3 font-weight-bold text-primary">Propagation Create Feedback</h6>
    ...
    <?php include 'functions/deleter.php'?>
    </div>
    ...
    <ul class="nav nav-pills">
        ...
        <!--  <li class="active">
			...
			<a  href="activate.php" class="btn btn-success  btn-circle" ><i class="fa fa-check"></i><i class="fa fa-user"></i> </a>
				...
				<li class="">
         	<a  href="historypost.php" class="btn btn-info btn-circle .btn-lg"><i class="fa fa-history" data-toggle="tooltip" title="Proceed to Feedback History"></i> </a>
				</li> 
				</li>
    ...
    <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    <!-- <td width="40">
                        <a  href="editfeedback.php?id=<?php echo $id; ?>&month=<?php echo $month; ?>&yr=<?php echo $yr;?>&batch=<?php $batch;?>&week=<?php echo $week;?>&status=<?php echo $status;?>"   class="btn btn-success"><i class="fa fa-edit"></i></a>
												</td> -->
...
<?php include 'managelongprop.php' ?>
