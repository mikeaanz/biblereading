        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard-Week End Propagation Over All</h1>
<!--             <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
          ...
          <?php 
                ...
                where userlevel.LEVEL='WEEKEND' or userlevel.LEVEL='5 DAYS PROPAGATION' ")or die(mysql_error());
                              ...
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Local Saint Attending Small Group Meetings</div>
                                          <div class="h5 mb-0 font-weight-bold text-gray-800 counter" data-count="<?php echo $row['LOCALATTSMLMTG'];?>">0</div>                                </div>
                                <div class="col-auto">
                                  <i class="fas fa-users fa-4x text-dark-300"></i>
                                </div>
                              </div>
