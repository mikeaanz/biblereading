...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">5 DAYS / Week End / 5 Weeks Report</h6>
	  </a>
	...
	<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">	
			  ...
			  <th>Places</th> 
				...
				<?php
                            ...
                            where userlevel.LEVEL='LONG PROPAGATION' OR  userlevel.LEVEL='5 DAYS PROPAGATION'  OR userlevel.LEVEL='WEEKEND' 
				...
				<td class="m-3 font-weight-italic text-dark">  <?php echo $row['PLACES'];?> <?php echo $row['week'];?></td>
