...
<div class="col-xl-9 col-lg-6">
  <div class="card shadow mb-1">
    ...
    <ul class="nav nav-pills">
        ...
        <li class="">
         	<a  href="historypost.php" class="btn btn-success btn-circle .btn-lg"><i class="fa fa-arrow-left"></i> &nbsp;<i class="fa fa-newspaper"></i> </a>
				</li> 
        &nbsp;
				<li class="">
    ...
    <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    <td width="40">
                        <a  href="edithistorypost.php?id=<?php echo $id;?>"   class="btn btn-info btn-circle .btn-lg"><i class="fa fa-plus-circle "></i></a>
												</td>
...
<?php include 'manageeditpostact.php' ?>
