...
<input class="form-control form-control-sm" name="year" id="cost" type="text" onfocus="this.value=''"  onkeypress="return isNumberKey(event)"  placeholder="Please Enter Year" required/>
...
if($activated > 0){
    ...
    mysql_query("INSERT INTO `year`(`YR`) 
    VALUES ('$year')")or die(mysql_error());
