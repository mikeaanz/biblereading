...
<?php $historyfeedbackid = $_GET['historyfeedbackid']; ?>
<?php $ids = $_GET['id'];
$getbatch = $_GET['BATCH'];
 ?>
...
<ul class="breadcrumb">
		<a  class="btn btn-link btn-lg" href="recdistrict.php?locate_idpost=<?php echo $historyfeedbackid;?>&BATCH=<?php echo $getbatch;?>"><i class="fa fa-arrow-left "></i>Back</a>
	</ul>
<div class="row">
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Recovered District</h6>
	  </a>
...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/modalrecdisdelete.php'?>
              ...
              <th>Date Recovered :</th>
				...
				<?php	
							...
							$user_query = mysql_query("SELECT * FROM rec_district where rec_district.acc_id='$session_id'
							ORDER BY rec_district.dist_id DESC
							")or die(mysql_error());
				  ...
				  <td width="40">
				  <a  href="editrecdistrict.php?historyfeedbackid=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch;?>	"  class="btn btn-success"><i class="fa fa-edit"></i></a>
					
												</td>
			
				
				   <td><?php echo $row['districtname'];?></td>
					<td><?php echo $row['daterecovered'];?></td>
			  ...
			  <?php include 'functions/modaladdrecdistrict.php'?>
...
<?php //include 'mypropdataadd.php'?>
  ...
  <?php include 'estdistrictedit.php' ?>
