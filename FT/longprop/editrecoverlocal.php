...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <ul class="breadcrumb">
		...
		<a  class="btn btn-link btn-lg" href="recoveredlocal.php?locate_idpost=<?php echo $back;?>&BATCH=<?php echo $getbatch;?>"><i class="fa fa-arrow-left "></i>Back</a>
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Recovered Locality District</h6>
	  </a>
...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/modaldelrecoverlocal.php'?>
			  ...
			  <th></th>
			  <th></th>
              <th>Name of Recovered Locality:</th>
              ...
              <th>Date Recovered :</th>
				...
				<?php	
							...
							$user_query = mysql_query("SELECT * FROM recoverlocal where recoverlocal.acc_id='$session_id'
							ORDER BY recoverlocal.recover_id DESC
							")or die(mysql_error());
				  ...
				  <td width="40">
				  <a  href="editrecoverlocal.php?locate_idpost=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
					
												</td>
			
				
				   <td><?php echo $row['name'];?></td>
					<td><?php echo $row['daterecover'];?></td>
			  ...
			  <?php include 'functions/modrecoveraddlocal.php' ?>
...
<?php //include 'mypropdataadd.php'?>
  ...
  <?php include 'recoverlocalityupt.php' ?>
