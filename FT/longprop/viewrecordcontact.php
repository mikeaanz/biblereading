...
<!-- <div class="container"> -->
  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                 ...
                                                 WHERE current_teamdata.userlevel_id='3' and
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                                  <h5 class="text-primary text-right week">    <?php echo $row['LEVEL'];?></h5>
                    <!-- Card content -->
                    <div class="card" >
                   ...
                   <!-- Title -->
                        ...
                        <h5 class="card-text text-center bg-gradient-primary   " style="font-style:italic;"><a class="font-weight-bold" style='color:#BFEEF9' >Rev. 22:12 Behold, I come quickly, and My reward is with Me to render to each one as his work is.</a><span style='color:#F8FAFB' ></span></h5>
