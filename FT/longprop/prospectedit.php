...
<?php $historyfeedbackid = $_GET['id']; ?>
<?php $ids = $_GET['id']; ?>
<?php $back = $_GET['historyfeedbackid'];
$getbatch=$_GET['BATCH']; ?>
...
<ul class="breadcrumb">
	...
	<a  class="btn btn-link btn-lg" href="prospecttrain.php?locate_idpost=<?php echo $back;?>&BATCH=<?php echo $getbatch;?>"><i class="fa fa-arrow-left "></i>Back</a>
</ul>
...
$id=$row['pros_id'];
				  ...
				  <td width="40">
                  <a  href="prospectedit.php?historyfeedbackid=<?php echo $back; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
