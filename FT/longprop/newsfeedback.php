...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                              <h1 class="text-right week" style='color: #305DB9'>  <?php echo $row['week'];?></h1>
                    <!-- Card content -->
                    <div class="card" >
               ...
               <!--          <a href="myentry.php?locate_idpost=<?php echo $id; ?>" class="btn btn-success bg-gradient-primary  sidebar-dark" ><i class="fa fa-plus"></i>ADD DATA</a> -->
                       ...
                       <button  onclick="window.location.href='myentry.php?locate_idpost=<?php echo $id; ?>&BATCH=<?php echo $batch;?>'"   class="btn bg-gradient-primary" data-toggle="tooltip" title="Add Data" <?php echo $row['list'];?>><i class=" text-white fa fa-plus-circle"></i></button>
                        <hr>
                    </div>
