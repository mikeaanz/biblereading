  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <i class="fas fa-trash fa-4x mb-4 text-danger" aria-hidden="true"></i>
       <p>Are you sure? Do you want to DELETE this Information! This current Data also will Delete the Propagation Monitored Contact Services, Please be aware of it, Thank you.
        </div>
      </div>
...
for($i=0; $i < $N; $i++)
{
  ...
  $monitored = mysql_query("DELETE FROM longproprpt where contact_id='$id[$i]'");
}
