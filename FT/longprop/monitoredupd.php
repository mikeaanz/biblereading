...
<?php include 'functions/session.php'?>
   ...
   <a  href="monitoringcont.php?id=<?php echo $moni;?>&week=<?php echo $week; ?>" class="btn btn-link  btn-smll" data-toggle="tooltip" title="List All Positive Contact's" ><i class="fa fa-arrow-left" ></i>Back</a>
   <?php include 'monitoredupdatecon.php'?>
