...
<ul class="breadcrumb">
	<a  class="btn btn-link btn-lg" href="recestlocal.php?locate_idpost=<?php echo $back;?>&BATCH=<?php echo $getbatch;?>	"><i class="fa fa-arrow-left "></i>Back</a>
</ul>
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Recovered Saints</h6>
	  </a>
...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
			  ...
			  <th></th>
			  <th></th>
			  <th>Name of Recovered Saints :</th>
			  ...
			  <th>Contact # :</th>
				...
				<?php	
							...
							INNER JOIN stat_saints on stat_saints.stat_id =  recoversaints.Status where recoversaints.acc_id='$session_id'
				  ...
				  <td width="40">
                  <a  href="editrecovered.php?historyfeedbackid=<?php echo $back; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
					
												</td>
			
				
				   <td><?php echo $row['Name'];?></td>
					<td><?php echo $row['Date_recovered'];?></td>
			  ...
			  <?php include 'functions/modalrecovered.php' ?>
