  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
            ...
            <label class="control-label" >Name of Prospect Trainee:</label>
                        <input class="form-control form-control-lg" name="name"  id="price" type="text"  disabled/>

 
                        <label class="control-label" for="price">Cell-Phone #:</label>
			<input class="form-control form-control-lg" name="cell" id="price" type="Number" onkeypress="return isNumberKey(event)"   placeholder="Example +6393045311711" maxlength="11" disabled/>
      ...
      <a  href="#success"  class="btn btn-primary  btn-smll"  disabled><i class="fa fa-recycle" disabled></i> Update</a>
      </div>
      </div>
      </div>
      </div>
