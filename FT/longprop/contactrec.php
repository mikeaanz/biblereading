  ...
  <?php
                                               ...
                                               LEFT JOIN year on historyfeedback.YEAR=year.ID
                                                  ...
                                                  LEFT JOIN week on historyfeedback.WEEK=week.ID
                                                   ...
                                                   where historyfeedback.acc_id='3' ORDER BY historyfeedback.id DESC
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                              <h1 class="m-3 font-weight-bold text-primary     sidebar-dark  text-right week" style='color: #11a255 '>     <?php echo $row['week'];?></h1>
                    <!-- Card content -->
                    <div class="card" >

                   <!-- Title -->
                        <b><h4 class="m-3 font-weight-bold text-primary  text-center " ><a><?php echo $row['LEVEL'];?></a></h4>  <b>
                        ...
                        <p class="card-text text-center bg-gradient-primary  sidebar-dark" style="font-style:italic;"><a style='color:#F8FAFB' > Post Started on </a><span style='color:#F8FAFB' ><?php echo $row['date_started'];?></span></p>
    ...
    <!--                     <a href="contactadd.php?id=<?php echo $id; ?>&week=<?php echo $week; ?>" class="btn btn-success bg-gradient-info  sidebar-dark" ><i class="fa fa-plus"></i>ADD DATA</a> -->
                          ...
                          <button onclick="window.location.href='contactadd.php?id=<?php echo $id; ?>&week=<?php echo $week; ?>'"   class="btn btn-primary" data-toggle="tooltip" title="Service Contact" <?php echo $row['list'];?>><i class="fa fa-plus-circle"></i></button>
