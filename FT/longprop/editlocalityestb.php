...
<?php $ids = $_GET['id']; $getbatch=$_GET['BATCH']; ?>
...
<ul class="breadcrumb">
			<a  class="btn btn-link btn-lg" href="establishlocality.php?locate_idpost=<?php echo $historyfeedbackid;?>&BATCH=<?php echo $getbatch;?>"><i class="fa fa-arrow-left "></i>Back</a>
		</ul>
<div class="row">
...
<div class="card shadow mb-4">
	  ...
	  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseCardExample">
		<h6 class="m-0 font-weight-bold text-primary text-center">Establish Locality</h6>
	  </a>
...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/moddeleteestlocal.php'?>
			  ...
			  <th></th>
			  <th></th>
              <th>Name of Establish Locality:</th>
              <th>Date Establish :</th>
				...
				<?php	
							...
							$user_query = mysql_query("SELECT * FROM establish_local where establish_local.acc_id='$session_id'
							ORDER BY establish_local.localest_id DESC
							")or die(mysql_error());
				  ...
				  <td width="40">
				  <a  href="editlocalityestb.php?locate_idpost=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>&BATCH=<?php echo $getbatch;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
					
												</td>
			
				
				   <td><?php echo $row['local_name'];?></td>
					<td><?php echo $row['date_establish'];?></td>
			  ...
			  <?php include 'functions/modalestablishlocal.php' ?>
