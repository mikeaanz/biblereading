        ...
        <!--   
         <ul class="breadcrumb">
          ...
          <?php 
                                ...
                                where  accounts_id='$session_id'  and userlevel.LEVEL='LONG PROPAGATION'
...
<?php 
                     ...
                     inner join historyfeedback on historyfeedback.id=recoversaints.historyfeedback
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                 where  recoversaints.acc_id='$session_id' and  userlevel.LEVEL='LONG PROPAGATION'
                             ")or die(mysql_error());
          ...
          <?php 
                $query = mysql_query("SELECT * from prospect_train 
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                   where  prospect_train.acc_id='$session_id' and  userlevel.LEVEL='LONG PROPAGATION'
                               ")or die(mysql_error());
          ...
          <?php 
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                 where  establish_local.acc_id='$session_id' and  userlevel.LEVEL='LONG PROPAGATION'
          ...
          <?php 
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                  where  recoverlocal.acc_id='$session_id' and  userlevel.LEVEL='LONG PROPAGATION'
          ...
          <?php 
                               ...
                               inner join historyfeedback on establish_dist.historyfeedback=historyfeedback.id 
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                  where  establish_dist.acc_id='$session_id' and  userlevel.LEVEL='LONG PROPAGATION'
          ...
          <?php 
                                ...
                                inner join userlevel on userlevel.id=historyfeedback.acc_id 
                                inner join status on status.id=historyfeedback.status_id 
                                  where  rec_district.acc_id='$session_id' and userlevel.LEVEL='LONG PROPAGATION'
