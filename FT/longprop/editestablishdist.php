...
<ul class="breadcrumb">
			<a  class="btn btn-link btn-lg" href="establishdistrict.php?locate_idpost=<?php echo $historyfeedbackid;?>&BATCH=<?php echo $getbatch;?>"><i class="fa fa-arrow-left "></i>Back</a>
		</ul>
