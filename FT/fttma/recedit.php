...
<div class="col-xl-3">
  <div class="card shadow mb-4">
    ...
    <label class="control-label" >Name of Brother and Sister:</label>
			...
			<input class="form-control form-control" name="cell" id="price" onkeypress="return isNumberKey(event)" placeholder="Example +6393045311711"  value="<?php echo $row['cellphone']; ?>" required/>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer ">
        ...
        <button name="saves" class="btn btn-primary"> Yes</button>
      </div>
    </div>
