...
<div class="container">
        ...
        <div class="float-left">
              <ul class="breadcrumb">
          <a  href="entryedit.php?locate_idpost=<?php echo $get_id; ?>&BATCH=<?php echo $getbatch;?>&id=<?php echo $id;?>" class="btn btn-link  btn-smll" data-toggle="tooltip" title="List All Positive Contact's" ><i class="fa fa-arrow-left" ></i>Back</a>
...
<!--     <a  href="#delete" class="btn btn-danger  btn-smll"  data-toggle="modal" data-target="#delete"><i class="fa fa-trash" data-toggle="tooltip" title="Delete"></i> </a>
 -->
    ...
    <?php include 'functions/modaladdrecbap.php' ?>
    </div>
...
//href='#edit_".$row['baptism_id']."'
                ...
                include 'functions/delmodalview.php';
                include 'functions/viewbaprec.php';
                include 'functions/editbaptismmodal.php';
