...
<?php include 'functions/session.php'?>
   ...
   <a  href="contactadd.php?id=<?php echo $get_id;?>&week=<?php echo $weeks;?>" class="btn btn-link  btn-smll" data-toggle="tooltip" title="List All Positive Contact's" ><i class="fa fa-arrow-left" ></i>Back</a>
   <?php include 'updatecontact.php'?>
