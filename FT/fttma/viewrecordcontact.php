...
?>
        ...
        <ul class="breadcrumb">
						...
						?>
							<li><a href="#"><b>My Contact Propagation :</b></a><span class="divider">/</span></li>
...
<!-- <div class="container"> -->
  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                 ...
                                                 WHERE current_teamdata.userlevel_id='2' and
                                               batch.BATCH='$term' and month.MONTH='$month' and year.YR='$year'
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                              <h5 class="text-info text-right week">    <?php echo $row['LEVEL'];?></h5>
                    <!-- Card content -->
                    <div class="card" >
                   ...
                   <!-- Title -->
                        ...
                        <!-- Text -->
                        <h5 class="text-dark  text-center week" style="font-style:italic;"><?php echo $row['MONTH'];?> <?php echo $row['YR'];?> <?php echo $row['BATCH'];?> </h5>
                        <h5 class="text-justify ">
                        <h5 class="card-text text-center bg-gradient-info   " style="font-style:italic;"><a class="m-3 font-weight-bold" style='color:#BFEEF9' >Rev. 22:12 Behold, I come quickly, and My reward is with Me to render to each one as his work is.</a><span style='color:#F8FAFB' ></span></h5>
...
<br>
                    ...
                    <div class="col text-center">	
                        <a href="addcontact.php?id=<?php echo $id; ?>" class="btn btn-primary bg-gradient-primary  sidebar-dark"><i class="fa fa-plus"></i> Contact Record</a>
                        <hr>
                    </div>
