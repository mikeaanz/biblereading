  ...
  <?php
                                               ...
                                               LEFT JOIN year on historyfeedback.YEAR=year.ID
                                                  ...
                                                  LEFT JOIN week on historyfeedback.WEEK=week.ID
                                                   ...
                                                   where historyfeedback.acc_id='2'  ORDER BY historyfeedback.id DESC
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                   ...
                   ,<?php echo $row['YR'];?>
                    ...
                    <button  onclick="window.location.href='myentry.php?locate_idpost=<?php echo $id; ?>&BATCH=<?php echo $batch;?>'"  class="btn btn-info" data-toggle="tooltip" title="Add Data" <?php echo $row['list'];?>><i class="fa fa-plus-circle"></i></button>

                    <!--     <a href="myentry.php?locate_idpost=<?php echo $id; ?>" class="btn btn-success bg-gradient-info  sidebar-dark" ><i class="fa fa-plus"></i>ADD DATA</a> -->
                        <hr>
                    </div>
