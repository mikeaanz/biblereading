...
<div class="col-xl-3">
  <div class="card shadow mb-4">
    ...
    <?php
							...
							INNER JOIN stat_saints on stat_saints.stat_id =  prospect_train.Status where prospect_train.pros_id='$id'
     ...
     ?>
			...
			<input class="form-control form-control-lg" name="cell" id="price" type="Number" placeholder="Example +6393045311711" maxlength="11" />
