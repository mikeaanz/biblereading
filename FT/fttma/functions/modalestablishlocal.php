...
echo '<script> swal({title: "Notice!",text: "Your data already existing.", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("establishlocality.php?locate_idpost='.$historyfeedbackid.'","_self")});</script>';
exit();
...
echo '<script> swal({title: "Good Job!",text: "Your Data Successfully Save!", customClass: "swal-wide",
  confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("establishlocality.php?locate_idpost='.$historyfeedbackid.'","_self")});</script>';
exit();
