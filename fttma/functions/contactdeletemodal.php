  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <i class="fas fa-trash fa-4x mb-4 text-danger" aria-hidden="true"></i>
          <p>Are you sure? Do you want to DELETE this Information! This current Data also will Delete the Propagation Monitored Contact Services, Please be aware of it, Thank you..</p
        </div>
      </div>
...
for($i=0; $i < $N; $i++)
{
	$result = mysql_query("DELETE FROM contatcdetails where contact_id='$id[$i]'");
  $monitored = mysql_query("DELETE FROM weekendrpt where contact_id='$id[$i]'");
}
echo '<script> swal({title: "Lord Jesus!",text: "This Data already Deleted!", customClass: "swal-wide",
