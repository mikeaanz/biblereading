...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
    ...
    <!--                     <a href="contactadd.php?id=<?php echo $id; ?>&week=<?php echo $week; ?>" class="btn btn-success bg-gradient-info  sidebar-dark" ><i class="fa fa-plus"></i>ADD DATA</a> -->
                          ...
                          <button  onclick="window.location.href='contactadd.php?id=<?php echo $id; ?>&week=<?php echo $week; ?>'"   class="btn btn-info" data-toggle="tooltip" title="Service Contact" <?php echo $row['list'];?>><i class="fa fa-plus-circle"></i></button>
