          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            $propagation = mysql_fetch_array($termquery);
                        ...
                        ?>
                         ...
                         <!--            <a href="#"  onclick="window.open('weekendpdf.php?SessionId= <?php echo $session_id ?> &TermNumber= <?php echo $term ?> &TermMonth= <?php echo $month ?> &TermYear= <?php echo $year ?>', 'newwindow', 'width=900, height=600'); return false;" class="d-show d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->



    <a id="btnGenerateReport" href="#"  onclick="window.open('weekendpdf.php?SessionId= <?php echo $session_id ?> &TermNumber= <?php echo $term ?>', 'newwindow', 'width=900, height=600'); return false;" class="d-show d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> 
          ...
          <ul class="breadcrumb">
						...
						?>
							...
							<li><a href="#"> <?php echo $propagation['BATCH']; ?> term
          ...
          <?php 
                                ...
                                where accounts_id='$session_id' and batch.BATCH='$term'")or die(mysql_error());
          ...
          <?php 
                                $query = mysql_query("select SUM(GOPENFOLLOW) AS GOPENFOLLOW from weekspropagation
                                inner join historyfeedback on historyfeedback.id=weekspropagation.historyfeedback_id
                                inner join month on month.id=historyfeedback.MONTH
                                inner join year on year.id=historyfeedback.YEAR 
                                inner join batch on batch.id=historyfeedback.BATCH 
          ...
          <?php }?>
                        ...
                        <?php 
                                $query = mysql_query("select SUM(TOTALHOMESMTG) AS 	TOTALHOMESMTG from weekspropagation
                                inner join historyfeedback on historyfeedback.id=weekspropagation.historyfeedback_id
                                inner join month on month.id=historyfeedback.MONTH
                                inner join year on year.id=historyfeedback.YEAR 
                                inner join batch on batch.id=historyfeedback.BATCH 
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800 counter" data-count="<?php echo $row['TOTALHOMESMTG'];?>">0</div>
                        ...
                        <?php 
                                $query = mysql_query("select SUM(PVISITEDNOTHMEET) AS 	PVISITEDNOTHMEET from weekspropagation
                                inner join historyfeedback on historyfeedback.id=weekspropagation.historyfeedback_id
                                inner join month on month.id=historyfeedback.MONTH
                                inner join year on year.id=historyfeedback.YEAR 
                                inner join batch on batch.id=historyfeedback.BATCH 
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800 counter" data-count="<?php echo $row['PVISITEDNOTHMEET'];?>">0</div>
                        ...
                        <?php 
                         ...
                         <div class="h5 mb-0 font-weight-bold text-gray-800 counter" data-count="<?php echo $row['SMALLGMTGHELD'];?>">0</div>                                </div>
                                <div class="col-auto">
                        ...
                        <?php 
								$query = mysql_query("SELECT SUM(MANHOURS) AS manhours from weekspropagation
                                          inner join historyfeedback on historyfeedback.id=weekspropagation.historyfeedback_id
                                inner join month on month.id=historyfeedback.MONTH
                                inner join year on year.id=historyfeedback.YEAR 
                                inner join batch on batch.id=historyfeedback.BATCH 
