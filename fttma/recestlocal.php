...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/modaldeleterec.php'?>
			  ...
			  <th>Contact # :</th>
				...
				<?php	
				  ...
				  <td width="40">
				  <a  href="editrecovered.php?historyfeedbackid=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
