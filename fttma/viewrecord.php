...
<!-- <div class="container"> -->
  ...
  <?php
                                               ...
                                               $user_query = mysql_query("SELECT * from current_teamdata
                                                 ...
                                                 WHERE current_teamdata.userlevel_id='2'
                                                --    where batch.BATCH='$term' and month.MONTH='$month' and year.YR='$year'
...
<div class="card shadow mb-1">
  ...
  <div class="card-body">
                   ...
                   <!-- Title -->
                        ...
                        <!-- Text -->
                        <h5 class="font-weight-bold text-dark  text-center" style="font-style:italic;"><?php echo $row['MONTH'];?> <?php echo $row['YR'];?> <?php echo $row['BATCH'];?> </h5>
