    ...
    <div class="table-responsive">
              ...
              <th>Date Establish :</th>
				...
				<?php	
				  ...
				  <td width="40">
				  <a  href="editlocalityestb.php?locate_idpost=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
...
<?php //include 'mypropdataadd.php'?>
  ...
  <?php include 'infolocalestablish.php' ?>
