...
<div class="card shadow mb-4">
	  ...
	  <div class="collapse show" id="collapseCardExample">
		<div class="card-body">
		<a  class="btn btn-link btn-lg" href="myentry.php?locate_idpost=<?php echo $back;?>"><i class="fa fa-arrow-left "></i>Back</a>
...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/moddelete.php'?>
...
$id=$row['pros_id'];
				  ...
				  <td width="40">
                  <a  href="prospectedit.php?historyfeedbackid=<?php echo $back; ?>&id=<?php echo $id;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
