...
<?php include 'functions/session.php'?>
   ...
   <a  href="addcontact.php?id=<?php echo $get_id;?>" class="btn btn-link  btn-smll" data-toggle="tooltip" title="List All Positive Contact's" ><i class="fa fa-arrow-left" ></i>Back</a>
