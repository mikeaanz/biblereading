    ...
    <center><label for="exampleInputEmail1">Weeks Control </label></center>
                  <Select class="browser-default custom-select" name="wk" id="userlevel" required>
                     ...
                     <option  disabled>Select Weeks</option>
                              <?php
                                  $query = mysql_query("SELECT * from week  where ID <> 1  ")or die(mysql_error());
		...
		<center>	<label class="control-label" > Day 3 :</label></center> 
                  <Select class="browser-default custom-select" name="three" id="userlevel" required>
                     ...
                     <option  disabled>Select Mode Status Saints</option>
                      ...
                      <div class="form-group">
    <center>  <label class="control-label" > Day 4 :</label></center> 
                  <Select class="browser-default custom-select" name="four" id="userlevel" required>
                     ...
                     <option  disabled>Select Mode Status Saints</option>
                      ...
                      <div class="form-group">
    <center>  <label class="control-label" > Day 5 :</label></center> 
                  <Select class="browser-default custom-select" name="five" id="userlevel" required>
...
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_six`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  exit();
   ...
   mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_seven`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  echo '<script> swal({title: "Praise the Lord!",text: "Your Data already Inserted!", customClass: "swal-wide",
   ...
   mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_eight`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  echo '<script> swal({title: "Praise the Lord!",text: "Your Data already Inserted!", customClass: "swal-wide",
   ...
   mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_nine`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  echo '<script> swal({title: "Praise the Lord!",text: "Your Data already Inserted!", customClass: "swal-wide",
   ...
   mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_ten`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
...
mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_eleven`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
...
mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_twelve`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_thirteen`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_fourteen`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_fifthteen`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_sixteen`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
  ...
  mysql_query("UPDATE `weekendrpt` SET 
`historyfeedback_id`='$moni',`acc_id`='$session_id',`week_seventeen`='$ones-$twos-$threes-$four-$five'
 WHERE weekendrpt_id='$get_id'")or die(mysql_error());
