...
$pdf->Cell(32,7,$Contact,1,0,'C');
 ...
 $pdf->SetTextColor(48,93,185); 
$pdf->SetFont('Times','B',3.5);

$pdf->Cell(23,7,$six,1,0,'C');
$pdf->Cell(23,7,$seven,1,0,'C');
$pdf->Cell(23,7,$eight,1,0,'C');
$pdf->Cell(23,7,$nine,1,0,'C');
$pdf->Cell(23,7,$ten,1,0,'C');
$pdf->Cell(23,7,$eleven,1,0,'C');
$pdf->Cell(23,7,$twelve,1,0,'C');
$pdf->Cell(23,7,$thirteen,1,0,'C');
$pdf->Cell(23,7,$fourteen,1,0,'C');
$pdf->Cell(23,7,$fifthteen,1,0,'C');
$pdf->Cell(23,7,$sixteen,1,0,'C');
$pdf->Cell(23,7,$seventeen,1,0,'C');
    $pdf->Ln();
