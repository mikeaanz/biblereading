...
<div class="col-lg-12">
  ...
  <div class="card mb-4">
    ...
    <div class="table-responsive">
				...
				<?php include 'functions/moddeldistest.php'?>
              ...
              <th>Date Recovered :</th>
				...
				<?php	
				  ...
				  <td width="40">
				  <a  href="editestablishdist.php?historyfeedbackid=<?php echo $historyfeedbackid; ?>&id=<?php echo $id;?>"  class="btn btn-success"><i class="fa fa-edit"></i></a>
			  ...
			  <?php include 'functions/modestablishdistrict.php' ?>
...
<?php //include 'mypropdataadd.php'?>
  ...
  <?php include 'estabeditdistrict.php' ?>
