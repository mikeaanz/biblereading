...
if($activated > 0){
   ...
   `establishname`='$name',
	...
	echo '<script> swal({title: "Good Job!",text: "Your Data Successfully Updated!", customClass: "swal-wide",
        confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("editestablishdist.php?historyfeedbackid='.$back.'&id='.$ids.'","_self")});</script>';
      exit();
...
echo '<script> swal({title: "Notice!",text: "Your data already existing.", customClass: "swal-wide",
    confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("editestablishdist.php?historyfeedbackid='.$back.'&id='.$ids.'","_self")});</script>';
  exit();
