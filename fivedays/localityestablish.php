  ...
  <div class="card shadow mb-4">
    ...
    <?php
     ...
     ?>
			...
			<input class="form-control form-control-lg" name="date" id="price" type="date" value="<?php echo $row['daterecover'];?>"  />
...
if($activated > 0){
   ...
   `name`='$name',
	...
	echo '<script> swal({title: "Good Job!",text: "Your Data Successfully Updated!", customClass: "swal-wide",
        confirmButtonColor: "#0BA9F9",type: "success"},function(){window.open("editrecoverlocal.php?locate_idpost='.$back.'&id='.$ids.'","_self")});</script>';
      exit();
...
echo '<script> swal({title: "Notice!",text: "Your data already existing.", customClass: "swal-wide",
    confirmButtonColor: "#0BA9F9",type: "error"},function(){window.open("editrecoverlocal.php?locate_idpost='.$back.'&id='.$ids.'","_self")});</script>';
  exit();
